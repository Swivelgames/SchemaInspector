...
!0)},initList:function(a){this.setContent(a,"main",SchemaInspector,function(a,b){var d=this;this.loadResource(this.getTplDir()+"details.html",function(a){d.initDetails(a[0],b)})});this.initialized.set("list",a)},initDetails:function(a,c){this.setContent(a,"details",c);this.initialized.set("details",a)},setContent:function(a,c,b,d){this.elementAttrMap(a,c,"prop",function(a,c){this.setElementValue(a,this.getPropFromStr(b,c))});this.elementAttrMap(a,c,"list",function(a,c){this.populateList(a,this.getPropFromStr(b,
c),d)})},populateList:function(a,c,b,d,e){var f=this,l=a.querySelector("[data-list-container]")||a;d||(d=a.querySelector("[data-list-item]"),d.parentNode.removeChild(d));for(var h in c){var k=c[h],g=d.cloneNode(!0,!1);k instanceof Array?this.populateList(a,k,b,d,h):(this.elementAttrMap(g,"list","key",function(a){this.setElementValue(a,e||h)}),this.elementAttrMap(g,"list","prop",function(a,b){this.setElementValue(a,this.getPropFromStr(k,b))}),b instanceof Function&&g.addEventListener("click",function(){var d=
Array.prototype.splice.apply(arguments,[0]);b.apply(f,d.concat([k,h,c,g,l,a,b]))}),l.appendChild(g))}},elementAttrMap:function(a,c,b,d){c="data-"+c+"-"+b;b=a.querySelectorAll("["+c+"]");if(!b||1>b.length)if(null!==a.getAttribute(c))b=[a];else return;for(a=0;a<b.length;a++){var e=b[a],f=e.getAttribute(c);null!==f&&d.call(this,e,f)}},elementAttrObjMap:function(a,c,b){for(var d in b){var e=b[d];this.elementAttrMap(a,c,"key",function(a){this.setElementValue(a,d)});this.elementAttrMap(a,c,"prop",function(a,
b){this.setElementValue(a,this.getPropFromStr(e,b))})}},setElementValue:function(a,c){var b=SchemaUtilities.determineValueAttr(a);return a[b]=c},getPropFromStr:function(a,c){var b=c.split(/\s+/),d=a;if(!(a instanceof Object))return a;for(var e=0;e<b.length;e++)d=d[b[e]];return d},getTplDir:function(){return this.schemaContext+this.tplDir},initStyles:function(){var a=document.createElement("link");a.setAttribute("rel","stylesheet");a.setAttribute("href",this.getTplDir()+"schema.css");return document.querySelector("head").appendChild(a)},
loadResource:function(a,c){var b=this.newXmlHttpRequest();if(!b)return!1;var d=this;b.onreadystatechange=function(){d.__tplResponseCallback.call(d,b,a,c)};b.open("GET",a,!0);b.setRequestHeader("Content-type","application/x-www-form-urlencoded");b.send();return!1},__tplResponseCallback:function(a,c,b){if(4==a.readyState)if(200==a.status){this.xhrCache[c]=a.responseText;var d=document.createElement("div");d.innerHTML=a.responseText;b.call(this,d.childNodes,a,c)}else throw Error("Error retrieving modal template. Response: "+
a.status);},newXmlHttpRequest:function(){try{return new XMLHttpRequest}catch(a){try{return new ActiveXObject("Msxml2.XMLHTTP")}catch(c){try{return new ActiveXObject("Microsoft.XMLHTTP")}catch(b){return!1}}}}};return f}();var SchemaUtilities=function(){var f=function(){};f.prototype={itemHasNoParent:function(a){for(var c=!0;a&&(a=a.parentElement);)null!==a.getAttribute("itemtype")&&(c=a,a=null);return c},isPropInScope:function(a,c){for(var b=a,d=!1;b&&(b=b.parentElement);)null!==b.getAttribute("itemtype")&&(d=b==c.dom?!0:!1,b=null);return d},getPropertyValue:function(a){switch(a.tagName.toLowerCase()){case "meta":return a.getAttribute("content");case "input":return a.getAttribute("value");case "link":case "a":return a.getAttribute("href");
